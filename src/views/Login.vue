          ...
          <form @submit.prevent="handleLogin">
            ...
            <div class="input-group">
              ...
              <div class="input-wrapper">
                ...
                <input id="password" v-model="password" :type="passwordVisible ? 'text' : 'password'" required placeholder="Enter password" />
...
export default defineComponent({
  ...
  setup() {
    ...
    return {
      email, password, passwordVisible, isLoading, notification,
      togglePasswordVisibility, handleLogin,
...
.theme-banner {
  flex: 0 0 45%; background-color: #AEE2E8; /* Original Blue/Green */
...
.login-form-area h2 { font-size: 2rem; font-weight: 700; margin-bottom: 25px; text-align: center; color: #000; }
...
.forgot-password-row { text-align: right; margin-top: -12px; margin-bottom: 25px; }
.forgot-link { color: #009200; font-size: 0.85rem; font-weight: 700; text-decoration: none; }
...
.login-button:hover { background-color: #007a00; transform: translateY(-1px); }
.login-button:disabled { background-color: #ccc; cursor: not-allowed; }

.separator { display: flex; align-items: center; text-align: center; margin: 20px 0; font-size: 0.8rem; color: #999; font-weight: 600; }
...
.signup-link { text-align: center; font-size: 0.85rem; color: #000; font-weight: 600; }
.signup-link .link { color: #009200; font-weight: 700; text-decoration: none; margin-left: 4px; }
.signup-link .link:hover { text-decoration: underline; }
...
@media (max-width: 992px) {
  ...
  .login-form-area { flex: 1; padding: 40px 30px; }
}
</style>
