    ...
    <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div class="relative bg-white w-full max-w-xl rounded-[32px] shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div class="p-8 space-y-5 overflow-y-auto">
          ...
          <div>
            ...
            <div class="grid grid-cols-2 gap-3">
              ...
              >
                <div class="w-10 h-10 rounded-xl flex items-center justify-center" :class="form.campaignType === 'promo_code' ? 'bg-emerald-500 text-white' : 'bg-slate-100 text-slate-400'">
              ...
              >
                 <div class="w-10 h-10 rounded-xl flex items-center justify-center" :class="form.campaignType === 'product_discount' ? 'bg-purple-500 text-white' : 'bg-slate-100 text-slate-400'">
            ...
            <div class="relative">
              ...
              <div v-if="showProductDropdown" class="absolute z-20 mt-2 w-full bg-white border border-slate-200 rounded-xl shadow-lg max-h-48 overflow-y-auto">
                ...
                <label v-for="product in products" :key="product._id" class="flex items-center gap-3 px-4 py-2.5 hover:bg-slate-50 cursor-pointer transition">
                  <input type="checkbox" :value="product._id" v-model="form.applicableProducts" class="w-4 h-4 rounded border-slate-300 text-emerald-600 focus:ring-emerald-500">
        ...
        <div class="p-6 border-t border-slate-100 bg-slate-50 flex justify-end gap-3">
          ...
          <button @click="$emit('save')" class="px-8 py-3 rounded-xl bg-slate-900 text-white font-bold shadow-lg hover:bg-slate-800 transition">
...
export default defineComponent({
  ...
  setup() {
    ...
    return { showProductDropdown, formatMoney };
  }
});
</script>
